...
### 2.1. Эксперимент с параметром $R_{max}$ для `xray`
...
![](./output/cartoon/cartoon_wan_rmax_60.bmp) 
...
### 2.3. Эксперимент с параметром $R_{max}$ для `map`
...
### 2.4. Эксперимент с параметром $R_{max}$ для `text1`
...
### 2.5. Эксперимент с параметром $R_{max}$ для `text2`
