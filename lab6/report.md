...
## Вывод
Можно заметить, что на 1ой строке "четвертый" символ является, на самом деле, двумя отдельными символами, как и на 2ой строке "двадцать шестой" символ. К сожалению даже применение 1ого и 2ого совета из текста лабораторной не помогло, так как их вертикальные косые профили не имеют выраженного разделения.
